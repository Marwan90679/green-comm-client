...
const DashboardLayout = () => {
  ...
  return (
    <div className='drawer md:drawer-open dark:bg-gray-950 bg-white dark:text-white' >
      <input id="sidebar-drawer" type="checkbox" className="drawer-toggle" />

      {/* Page Content */}
      <div className="drawer-content flex flex-col min-h-screen">
        {/* Top Navbar */}
        <div className="w-full flex items-center justify-between px-4 py-2 border-b shadow-md z-10">
      ...
      {/* Sidebar */}
      <div className={`drawer-side z-40 ${darkMode ? "bg-gray-800" : "bg-white"}`}>
        <label htmlFor="sidebar-drawer" className="drawer-overlay"></label>
        <div className="w-64 min-h-screen p-4 border-r border-gray-200 dark:border-gray-700">
